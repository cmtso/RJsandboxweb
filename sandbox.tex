...
the \CRANpkg{learnr} package, with the aim to bridge the gap between
...
\CRANpkg{learnr} tutorial in RStudio after \CRANpkg{learnr} is
installed, the user chooses a \CRANpkg{learnr} R Markdown template from
...
main features of the \CRANpkg{learnr} package are the ``exercise'' and
...
forbid users to skip sections. Like any Shiny apps, \CRANpkg{learnr}
...
for R beginners. We propose a novel application of the \CRANpkg{learnr}
...
Recognizing \CRANpkg{learnr} documents are themselves R Shiny web apps,
...
paper we have submitted for publication into a \CRANpkg{learnr} site
...
Since \CRANpkg{learnr} apps are R Markdown documents, Shiny UI elements
