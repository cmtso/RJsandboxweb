...
the \pkg{learnr} package to expose certain code chunks in R Markdown so that
...
\item
  ...
  Markdown document
\item
  Open a new \pkg{learnr} R Markdown template. Copy the content of
...
and tools such as \pkg{RAppArmor} \citep{RAppArmor}. While access to
...
To demonstrate our concept, we have turned an R Markdown notebook for one of our recent papers \citep{Tso2022} into a \pkg{learnr} site
...
\\\href{mailto:gblair@ceh.ac.uk}{\nolinkurl{gblair@ceh.ac.uk}}
}
