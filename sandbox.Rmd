...
author:
  ...
  # 20211124: check all features work both for web and pdf
...
header-includes:
   - \usepackage{subfig} # not needed, only needed for latex subfig for fig.subcap
...
`r if(knitr::is_latex_output()==FALSE) {paste0("'''","*{r fig2, warning=FALSE, exercise=TRUE, exercise.lines=30,fig.fullwidth=TRUE}*")}`
...
``` {r table1-descriptionsb, results = 'asis', echo = FALSE, message = FALSE, warning = FALSE, include=TRUE}
...
```
<!-- if(knitr::is_latex_output()==TRUE) {"Advantages of the proposed approach to various stakeholders"} else{"Table 1: Advantages of the proposed approach to various stakeholders"} -->
``` {r table1-descriptions, results = 'asis', echo = FALSE, message = FALSE, warning = FALSE, include=FALSE}
...
``` {r table2-descriptions, results = 'asis', echo = FALSE, message = FALSE, warning = FALSE, include=TRUE}
